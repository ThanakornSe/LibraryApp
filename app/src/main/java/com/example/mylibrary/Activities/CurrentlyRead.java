...
public class CurrentlyRead extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        booksRecView = findViewById(R.id.currentReadRecView);
        booksRecView.setLayoutManager(new LinearLayoutManager(this));

        bookViewModel = new ViewModelProvider.AndroidViewModelFactory(this.getApplication()).create(BookViewModel.class);
        BookViewModel.getBookByPlaylist(LibraryDatabase.CURRENTLY_READ).observe(this, new Observer<List<Book>>() {
            @Override
            public void onChanged(List<Book> books) {
                adapter = new BooksRecViewAdapter(CurrentlyRead.this,BooksRecViewAdapter.CURRENTLY_READ,books);
